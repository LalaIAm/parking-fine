...
const Privacy = () => {
  return (
    <div className='container p-5'>
      <h1>Privacy Policy for ParkEZFine</h1>

      <p>
        At ParkEZFine, accessible from parkezfine.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        ParkEZFine and how we use it.
      </p>
      ...
      <p>
        ParkEZFine follows a standard procedure of using log files. These files
        ...
        <a href='https://www.webterms.org/privacy-policy-generator/'>
      ...
      <p>
        Like any other website, ParkEZFine uses "cookies". These cookies are
      ...
      <p>
        ...
        advertising partners of ParkEZFine.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on ParkEZFine, which are sent
      ...
      <p>
        Note that ParkEZFine has no access to or control over these cookies that
      ...
      <p>
        ParkEZFine's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        ParkEZFine does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        shared and/or collect in ParkEZFine. This policy is not applicable to
